                        ...
                        .setPositiveButton("Yes", new DialogInterface.OnClickListener() {
                            ...
                            public void onClick(DialogInterface dialog, int which) {
                                databaseReference.child(ListFragment.keys.get(testing.pos))
                                        .child("bookName").setValue(null);
                                databaseReference.child(ListFragment.keys.get(testing.pos))
                                        .child("authorName").setValue(null);
                                databaseReference.child(ListFragment.keys.get(testing.pos))
                                        .child("edition").setValue(null);
                                databaseReference.child(ListFragment.keys.get(testing.pos))
                                        .child("price").setValue(null);
                                databaseReference.child(ListFragment.keys.get(testing.pos))
                                        .child("image1").setValue(null);
                                databaseReference.child(ListFragment.keys.get(testing.pos))
                                        .child("image2").setValue(null);
                                databaseReference.child(ListFragment.keys.get(testing.pos))
                                        .child("image3").setValue(null);
                                databaseReference.child(ListFragment.keys.get(testing.pos))
                                        .child("image4").setValue(null);
                                databaseReference.child(ListFragment.keys.get(testing.pos))
                                        .child("image5").setValue(null);
                                databaseReference.child(ListFragment.keys.get(testing.pos))
                                        .child("image6").setValue(null);
